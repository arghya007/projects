...
def main():
    ...
    model = st.sidebar.selectbox(
        'Choose a model',
        ['llama2-70b-4096', 'mixtral-8x7b-32768', 'Gemma-7b-lt']                           # Define a choices for LLM Model
    )
    ...
    user_question = st.text_area(
        "what's there to watch.. Tell me about an Actor, Director, Movie, or anything.. Still no clue? Okay let's start with how's youe mood! ")                                  # Define a prompt for question area
